...
function App() {
    ...
    return (
        <div className="App">
            ...
            <div>
                <h3 className='sub-header'> *Supports Image classes from: <a href="https://github.com/shahidedu7/imagenet-1000-classes/blob/main/classes_names.txt" target="_blank">ImageNet</a></h3>
            </div>
